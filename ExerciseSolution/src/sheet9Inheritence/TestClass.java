...
public class TestClass {
	public static void main(String[] args) {
		...
		one.setColour(Colour.BLUE);
		one.setMaterialType(MaterialType.GLASS);
		System.out.printf("\n\tFurniture one, %s\n\n\n", one);
		
		Table t1 = new Table(Colour.GREEN, MaterialType.STEEL, true, Shape.ICOSAGAN);
		System.out.println("\tTable :"+t1);
		
		Chair c1 = new Chair(Colour.RED, MaterialType.LEATHER, true, Type.LAZY);
		System.out.println("\tChair: "+c1);
		
		Bed b1 = new Bed(Colour.WHITE, MaterialType.NYLON, false, Size.GRAND_KING);
		System.out.println("\tBed:"+b1);
		...
		System.out.printf("\n\tCreate Table myTable using the no-args constructor, set the member "
